...
<div class="container my-5">
        ...
        <div class="row">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteTaskLabel<?= $task["id"]; ?>">Edit Task</h5>
                                            ...
                                            <form method="POST" action="/task/edit">
                                                <div class="mb-3">
                                                    <div class="">
                                                        ...
                                                        <input required type="text" class="form-control" id="title" name="title" value="<?php echo $task['title'] ?>"/>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="description" class="form-label">Description</label>
                                                    <textarea required  type="text" class="form-control" id="description" name="description" rows="5"><?php echo $task['description'] ?></textarea>
                                                </div>
                                                <div class="d-grid">
                            ...
                            <ul class="list-group mb-3">
                                <?php foreach ($comments as $comment): ?>
                                    <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <div>
                                            <!-- edit button -->
                                            <form method="POST" action="/comment/edit" class="d-inline">
            ...
            <!-- submission section -->
            <?php if (!isStudent()): ?>
            <div class="card p-3 col-lg-6 col-md-6 col-sm-12 h-100">
